...
<div class="container-fluid bg-pink">
  <div class="row">
    <div class="col-md-6">
      <picture class="">
        <img class="img-fluid" src="/css/images/photo-gallery-min.png" alt="" />
      </picture>
    </div>
    ...
    <div class="card-columns">
      <div class="">
        <div class=" column animals show">
          <div class="card">
            <img class="card-img-top" src="/uploads/animals/IMAGE (18).jpg" alt="Card image cap">
          </div>
        </div>
        <div class="column animals show">
          <div class="card">
            <img class="card-img-top" src="/uploads/animals/IMAGE (21).jpg" alt="Card image cap">
          </div>
        </div>
        <div class=" column animals show">
          <div class="card">
            <img class="card-img-top" src="/uploads/animals/IMAGE (22).jpg" alt="Card image cap">
          </div>
        </div>
      </div>
      <div class="">
        <div class=" column animals show">
          <div class="card">
            <img class="card-img-top" src="/uploads/animals/IMAGE (27).jpg" alt="Card image cap">
          </div>
        </div>
        <div class="column animals show">
          <div class="card">
            <img class="card-img-top" src="/uploads/animals/IMAGE (3).jpg" alt="Card image cap">
          </div>
        </div>
        <div class=" column animals show">
          <div class="card">
            <img class="card-img-top" src="/uploads/animals/IMAGE (4).jpg" alt="Card image cap">
          </div>
        </div>
      </div>
      <div class="">
        <div class=" column animals show">
          <div class="card text-white text-center">
            <img class="card-img-top" src="/uploads/animals/IMAGE (6).jpg" alt="Card image cap">
          </div>
        </div>
        <div class="column cars show">
          <div class="card text-center">
            <img class="card-img-top" src="/uploads/cars/IMAGE (26).jpg" alt="Card image cap">
          </div>
        </div>
        <div class="column cars show">
          <div class="card">
            <img class="card-img" src="/uploads/cars/IMAGE (28).jpg" alt="Card image">
          </div>
        </div>
      </div>
      <div class="">
        <div class=" column farm show">
          <div class="card text-right">
            <img class="card-img-top" src="/uploads/farm/IMAGE (14).jpg" alt="Card image cap">
          </div>
        </div>
        <div class=" column history show">
          <div class="card">
            <img class="card-img-top" src="/uploads/history/IMAGE (2).jpg" alt="Card image cap">
          </div>
        </div>
        <div class="column history show">
          <div class="card">
            <img class="card-img-top" src="/uploads/history/IMAGE (23).jpg" alt="Card image cap">
          </div>
        </div>
        <div class="column history show">
          <div class="card">
        ...
        <div class="column history show">
          <div class="card">
            <img class="card-img-top" src="/uploads/history/IMAGE (24).jpg" alt="Card image cap">
          </div>
        </div>
        <div class="column history show">
          <div class="card">
            <img class="card-img-top" src="/uploads/history/IMAGE (25).jpg" alt="Card image cap">
          </div>
        </div>
