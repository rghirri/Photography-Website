...
<div id="owl-demo" class="owl-carousel owl-theme">
 ...
 <div class="item"><img src="{{ asset("/storage/".$slider->slider) }}" alt="Owl Image"
 ...
 <div class="container mt-1">
  <div class="row">
   <div class="mt-3 col-lg-4">
    <div class="card">
     <img class="card-img-top" src="{{ asset("/storage/".$speciality->imageone) }}" alt="Card image cap"
   ...
   <div class="mt-3 col-lg-4">
    <div class="card">
     <img class="card-img-top" src="{{ asset("/storage/".$speciality->imagetwo) }}" alt="Card image cap"
      style="width: 350px; height: 228px; object-fit: cover;" />
     <div class="card-body d-flex flex-column justify-content-center align-items-center">
   ...
   <div class="mt-3 col-lg-4">
    <div class="card">
     <img class="card-img-top" src="{{ asset("/storage/".$speciality->imagethree) }}" alt="Card image cap"
      style="width: 350px; height: 228px; object-fit: cover;" />
     <div class="card-body d-flex flex-column justify-content-center align-items-center">
