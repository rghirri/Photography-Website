  ...
  <table class="table">
   ...
   <tbody>
    ...
    <tr>
     ...
     <td>
      <figure> <img src="{{ asset("/storage/".$speciality->imageone) }}" width="200" height="200" alt=""></figure>
      <h3>{{ $speciality->one }}</h3>
      <p>{!! $speciality->onedetails !!}</p>
     </td>
     <td>
      <figure><img src="{{ asset("/storage/".$speciality->imagetwo) }}" width="200" height="200" alt=""></figure>
      <h3>{{ $speciality->two }}</h3>
      <p>{!! $speciality->twodetails !!}</p>
     </td>
     <td>
      <figure><img src="{{ asset("/storage/".$speciality->imagethree) }}" width="200" height="200" alt=""></figure>
